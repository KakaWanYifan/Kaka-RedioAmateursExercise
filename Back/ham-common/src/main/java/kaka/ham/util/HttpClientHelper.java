...
public class HttpClientHelper
{
	 ...
	 */
	public static String sendPost_HttpURL(String urlParam, Map<String, Object> params, String charset)
	{
	 ...
	 */
	public static String sendPost_URL(String urlParam, Map<String, Object> params, String charset) {
		StringBuffer resultBuffer = null;
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
		if (params != null && params.size() > 0) {
	 ...
	 * @time:2016年5月17日 下午3:27:29
	 */
	public static String sendGet_HttpURL(String urlParam, Map<String, Object> params, String charset) {
		StringBuffer resultBuffer = null;
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
		if (params != null && params.size() > 0) {
	 ...
	 */
	public static String sendGet_URL(String urlParam, Map<String, Object> params, String charset) {
		StringBuffer resultBuffer = null;
		// 构建请求参数
		StringBuffer sbParams = new StringBuffer();
		if (params != null && params.size() > 0) {
